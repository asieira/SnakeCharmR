...
Make sure the desired Python interpreter is on the PATH, as well as its equivalent
`python-config` command. The latter will be used to determine the location of the
libraries and headers necessary to compile SnakeCharmR.
